...
public partial class Sehvlrsddetail
{
    ...
    public virtual Sehvlrsd IdHvlrsdNavigation { get; set; } = null!;
    ...
    public virtual ICollection<Sehvlrsddetailpallet> Sehvlrsddetailpallets { get; set; } = new List<Sehvlrsddetailpallet>();
